...
module Data.Array.Accelerate.Debug.Internal.Flags (
  ...
  fast_permute_const, debug, verbose, dump_phases, dump_sharing, dump_fusion,
...
flush_cache           = Flag  7 -- delete persistent compilation cache(s)
force_recomp          = Flag  8 -- force recompilation of array programs
